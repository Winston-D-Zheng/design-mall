...
create Table if not exists db_hms_promotion
(
...
create Table if not exists db_hms_promotion_product
(
    id         bigint unsigned auto_increment
        primary key,
    product_id bigint                       not null,
...
create Table if not exists db_hms_promotion_shop
(
    id         bigint unsigned auto_increment
        primary key,
...
create Table if not exists db_pms_category
(
    id            bigint unsigned auto_increment
        primary key,
...
create Table if not exists mms_chat_group
(
...
create Table if not exists mms_chat_group_user
(
    id        bigint auto_increment
        primary key,
...
create Table if not exists mms_chat_message
(
    id            bigint auto_increment
        primary key,
